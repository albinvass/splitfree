...
func (eu *ExpenseUpdate) SetPaidBy(u uuid.UUID) *ExpenseUpdate {
	eu.mutation.SetPaidBy(u)
	return eu
}

// SetNillablePaidBy sets the "paid_by" field if the given value is not nil.
func (eu *ExpenseUpdate) SetNillablePaidBy(u *uuid.UUID) *ExpenseUpdate {
	if u != nil {
		eu.SetPaidBy(*u)
	}
	return eu
...
func (eu *ExpenseUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := eu.mutation.PaidBy(); ok {
		_spec.SetField(expense.FieldPaidBy, field.TypeUUID, value)
	}
	...
	if eu.mutation.DebtorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: expense.DebtorsPrimaryKey,
			Bidi:    false,
...
// SetPaidBy sets the "paid_by" field.
func (euo *ExpenseUpdateOne) SetPaidBy(u uuid.UUID) *ExpenseUpdateOne {
	euo.mutation.SetPaidBy(u)
	return euo
}

// SetNillablePaidBy sets the "paid_by" field if the given value is not nil.
func (euo *ExpenseUpdateOne) SetNillablePaidBy(u *uuid.UUID) *ExpenseUpdateOne {
	if u != nil {
		euo.SetPaidBy(*u)
	}
	return euo
...
func (euo *ExpenseUpdateOne) sqlSave(ctx context.Context) (_node *Expense, err error) {
	...
	if value, ok := euo.mutation.PaidBy(); ok {
		_spec.SetField(expense.FieldPaidBy, field.TypeUUID, value)
	}
