...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.ForeignKeys[0]: // expense_debtors
			values[i] = new(sql.NullInt64)
		default:
	...
	for i := range columns {
		...
		case user.ForeignKeys[0]:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for edge-field expense_debtors", value)
			} else if value.Valid {
				u.expense_debtors = new(int)
				*u.expense_debtors = int(value.Int64)
			}
		default:
