...
func (m *ExpenseMutation) SetPaidByID(id int) {
	m.paid_by = &id
}

// ClearPaidBy clears the "paid_by" edge to the User entity.
func (m *ExpenseMutation) ClearPaidBy() {
	m.clearedpaid_by = true
}

// PaidByCleared reports if the "paid_by" edge to the User entity was cleared.
func (m *ExpenseMutation) PaidByCleared() bool {
	return m.clearedpaid_by
}

// PaidByID returns the "paid_by" edge ID in the mutation.
func (m *ExpenseMutation) PaidByID() (id int, exists bool) {
	if m.paid_by != nil {
		return *m.paid_by, true
	}
	return
}

// PaidByIDs returns the "paid_by" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// PaidByID instead. It exists only for internal usage by the builders.
func (m *ExpenseMutation) PaidByIDs() (ids []int) {
	if id := m.paid_by; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetPaidBy resets all changes to the "paid_by" edge.
func (m *ExpenseMutation) ResetPaidBy() {
	m.paid_by = nil
	m.clearedpaid_by = false
}
...
func (m *ExpenseMutation) AddedEdges() []string {
	...
	if m.paid_by != nil {
		edges = append(edges, expense.EdgePaidBy)
	}
	if m.debtors != nil {
