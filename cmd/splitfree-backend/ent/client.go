...
// QueryPaidBy queries the paid_by edge of a Expense.
func (c *ExpenseClient) QueryPaidBy(e *Expense) *UserQuery {
...
// QueryDebtors queries the debtors edge of a Expense.
func (c *ExpenseClient) QueryDebtors(e *Expense) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := e.ID
		step := sqlgraph.NewStep(
